  ...
  <div class="py-12 mt-12">
    <div class="container mx-auto">
      <section class="mb-32 text-gray-500">
        <div class="relative overflow-hidden bg-no-repeat  bg-[url('../assets/kleppit-low-resolution-logo-white-on-transparent-background.png')] py-28" style="background-position: 50%;"></div>
        <div class="container text-gray-800 px-4 md:px-12">
          <div class="block rounded-lg shadow-lg py-10 md:py-12 px-2 md:px-6 -mt-12 backdrop-blur-md	 bg-zinc-800 border rounded-md border-zinc-700">
            <div class="flex flex-wrap justify-between">
              <div class="flex justify-center mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                <div class="flex items-start">
                  <div class="shrink-0">
                    <div class="p-4 bg-red-500 rounded-md shadow-md w-14 h-14 flex items-center justify-center">
                  ...
                  <div class="grow ml-6">
                    ...
                    <p class="text-gray-500">support@kleppit.com</p>
                    <p class="text-gray-500">+30 6981020345</p>
                  </div>
                </div>
              </div>
              <div class="flex justify-center mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                <div class="flex items-start">
                  ...
                  <div class="grow ml-6">
                    ...
                    <p class="text-gray-500">sales@kleppit.com</p>
                    <p class="text-gray-500">+30 6982959584</p>
                  </div>
                </div>
              </div>
              <div class="flex justify-center mb-12 md:mb-0 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                <div class="flex">
                  <div class="shrink-0">
                    <div class="p-4 bg-red-500 rounded-md shadow-md w-14 h-14 flex items-center justify-center">
                  ...
                  <div class="grow ml-6">
                    ...
                    <p class="text-gray-500">press@kleppit.com</p>
                    <p class="text-gray-500">+30 6982394985</p>
                  </div>
                </div>
              </div>
              <div class="flex justify-center grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                <div class="flex">
                  <div class="shrink-0">
                    <div class="p-4 bg-red-500 rounded-md shadow-md w-14 h-14 flex items-center justify-center">
                  ...
                  <div class="grow ml-6">
                    ...
                    <p class="text-gray-500">bugs@kleppit.com</p>
                    <p class="text-gray-500">+30 6945919683</p>
                  </div>
                </div>
              </div>
            </div>
