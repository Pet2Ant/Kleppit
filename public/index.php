...
-->
  <body id="page" class="scroll-smooth bg-zinc-900 md:scrollbar-default ">
    ...
    <header id="header" class="fixed inset-0 z-50 flex h-14 bg-[#1a1a1b] select-none">
      <div
        class="flex flex-1 items-center space-x-4 border-b border-[#343536] px-5"
      >
        ...
        <div class="flex flex-1 items-center space-x-4">
          ...
          <!-- Post button -->
          <button onclick="location.href = './createPost.html';"
           class="w-14 text-md font-bold bg-gray-300 transition duration-500 ease-in-out hover:bg-gray-400 rounded-full p-1 lg:hidden"
          >
          Post
          </button>
          <!-- Search bar -->
          <div
            class="mx-4 flex flex-1 items-center space-x-3 rounded border border-[#343536] bg-[#272729] px-4 py-1.5"
          >
            <svg
            ...
            <input
              class="flex-1 bg-transparent text-sm focus:outline-none text-gray-400"
              type="text"
              placeholder="Search Kleppit"
            />
          </div>
        </div>
        <!-- User button -->
        <div class="space-x-4 py-6 flex flex-col justify-center ">
          <div class="flex items-center justify-center">
            <div class="relative inline-block text-left dropdown">
              <span class="rounded-md shadow-sm">
                <button class="flex items-center w-full text-sm font-medium leading-5 text-[#ff4057] transition duration-150 ease-in-out hover:text-red-600" type="button" aria-haspopup="true" aria-expanded="true" aria-controls="headlessui-menu-items-117">
                  <img
                    ...
                    src="../assets/tacejm6avjx41.jpg"
                    alt="user photo"
                  />
                  <p class="hidden lg:block">Bonnie Green</p>
                  <svg
                    class="w-4 h-4 mx-1"
                    aria-hidden="true"
                    fill="currentColor"
              ...
              >
                <div
                  class="absolute right-0 w-56 mt-2 origin-top-right bg-[#1a1a1b] border border-[#343536] divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                ...
                >
                  <div class="px-4 py-3">
                    ...
                    <p
                      class="text-md font-semibold leading-5 text-[#ff4957] truncate"
                    >
                      tom@example.com
                    </p>
                    <p
                      class="text-sm leading-5 text-[#ff4957] truncate py-1"
                    >
                      1234 Upvotes
                    </p>
                  </div>
                  <div class="py-1">
                    <a
                      ...
                      tabindex="0"
                      class="text-gray-400 flex justify-between w-full px-4 py-2 text-sm leading-5 text-left transition duration-500 ease-in-out hover:text-gray-500"
                      role="menuitem"
                      >Account settings</a
                    >
                    <a
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    ...
                    <div class="mt-1 flex rounded-md">
                      <input placeholder="Name" type="text"
                          class="text-sm block px-3 py-2 rounded-lg w-full placeholder-text-lg bg-zinc-800 border-2 border-zinc-700 placeholder-zinc-600 shadow-md focus:placeholder-zinc-500 focus:bg-zinc-900 focus:border-zinc-600 text-gray-500 focus:outline-none"></input>
                    </div>
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    ...
                    <div class="mt-1 flex rounded-md">
                      <input placeholder="Your last name" type="text"
                          class="text-sm block px-3 py-2 rounded-lg w-full placeholder-text-sm text-gray-500 bg-zinc-800 border-2 border-zinc-700 placeholder-zinc-600 shadow-md focus:border-zinc-600 text-[#ff4957] focus:outline-none"></input>
                    </div>
        ...
        <div class="flex w-960 mx-auto">
          ...
          <div class="w-11/12 ml-5">
            ...
            <div id="" class="py-2 mb-4">
              <div
                class="flex border border-[#343536] bg-[#272729] transition duration-500 ease-in-out hover:border-red-500 rounded cursor-pointer"
              >
                <div class="w-5 mx-4 flex flex-col text-center pt-2">
                  <!-- Upvote -->
                  <button class="text-xs">
                    <svg
                      class="w-5 fill-current text-gray-500 transition duration-500 hover:text-[#ff4057]"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                    >
                  ...
                  <!-- Vote count -->
                  <span class="text-xs font-semibold my-1 text-gray-500"
                    >20k</span
                  >
                  <!-- Downvote -->
                  <button class="text-xs">
                    <svg
                      class="w-5 fill-current text-gray-500 transition duration-500 hover:text-blue-500"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                    >
                ...
                <div class="w-11/12 pt-2">
                  <div class="flex items-center text-xs mb-2">
                    ...
                    <a
                      href="#"
                      class="text-gray-500 mx-1 no-underline hover:underline"
                      >u/TestUser</a
                    >
                  ...
                  <div class="inline-flex items-center my-1">
                    <div
                      class="flex transition duration-500 hover:bg-gray-700 p-1 rounded-lg"
                    >
                      <svg
                    ...
                    <!-- Share -->
                    <div
                      class="flex transition duration-500 hover:bg-gray-700 p-1 ml-2 rounded-lg"
                    >
                      <svg
                        class="w-4 fill-current text-gray-500"
                        xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="py-2 mb-4">
              ...
              >
                ...
                <div class="w-11/12 pt-2">
                  ...
                  <div class="flex flex-col text-center py-2">
                    <img
                      src="../assets/Screenshot_20221022_111506.png"
                      alt="Post Image"
                      class="rounded-lg mr-4"
                    />
                    <h3 class="text-gray-500 text-md py-2">
          ...
          <div class="w-1/3 pl-9 hidden lg:block">
            ...
            <div class="py-2">
              <div class="flex justify-center items-center bg-zinc-900">
                <div
                  class="w-80 pb-2 border border-gray-500 rounded-lg overflow-hidden"
                >
                  <div
                    class="p-3 bg-[url('../assets/kleppit-high-resolution-logo-white-on-black-background-cropped.png')] bg-contain object-cover h-16"
                  ></div>
              ...
              <div class="p-2">
                <div class="flex items-center">
                  ...
                  <div class="flex flex-col">
                    <span class="text-xs font-semibold text-gray-400 mb-1"
                      >Non-Profit Kleppit</span
                    >
                    <span class="text-xxs font-semibold text-gray-400"
                      >No ads, for your browsing pleasure!</span
                    >
                  </div>
                </div>
              </div>
              ...
              <div class="p-3">
                <div class="flex justify-between">
                  <div>
                    <a
                      href="./About.html"
                      class="block no-underline text-xs font-semibold text-gray-400 transition duration-500 ease-in-out hover:text-gray-500"
                      >About</a
                    >
                  </div>
                  <div>
                ...
                <div class="text-center mt-6">
                  <p class="text-xs leading-tight text-gray-400 font-medium">
                    <a
                      ...
                      class="no-underline text-gray-400 transition duration-500 ease-in-out hover:text-gray-500"
                      >User Agreement</a
                    >
                    |
                    <a
                  ...
                  <p
                    class="text-xs leading-tight font-medium text-[#ff4057] my-1"
                  >
