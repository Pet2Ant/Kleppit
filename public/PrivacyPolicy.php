...
-->
      ...
      <body id="page" class="scroll-smooth bg-zinc-900 md:scrollbar-default">
        ...
        <header
          id="header"
          class="fixed inset-0 z-50 flex h-14 bg-[#1a1a1b] select-none"
        >
          <div
            ...
            <div class="flex flex-1 items-center space-x-4">
              ...
              <a id="largeLogo" href="./index.php"
                ><img
                  ...
                  class="hidden lg:inline-block h-10 transition duration-500 ease-in-out hover:opacity-75"
                  alt="logo"
                />
              </a>
              <!-- Small Logo -->
              ...
              <div class="flex items-center justify-center">
                <div class="relative inline-block text-left dropdown">
                  <span class="rounded-md shadow-sm">
                    <button
                      class="flex items-center w-full text-sm font-medium leading-5 text-red-500 transition duration-150 ease-in-out hover:text-red-600"
                      type="button"
                      aria-haspopup="true"
                      aria-expanded="true"
                  ...
                  >
                    ...
                    >
                      <div class="px-4 py-3">
                        ...
                        <p
                          class="text-md font-semibold leading-5 text-red-600 truncate"
                        >
                ...
                ?>
                        <a
                          href="./signupform.php"
                          tabindex="4"
                          class="text-red-500 flex justify-between w-full px-4 py-2 text-sm leading-5 text-left transition duration-500 ease-in-out hover:text-red-600"
                          role="menuitem"
                          >Signup</a
                        >
        ...
        <div id="main" class="py-12 mt-12 relative">
          <div class="w-11/12 p-4 h-full text-gray-500">
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to KIeppit.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to KIeppit, accessible from
                  <a
                    href="https:www.kleppit.com"
                    rel="external nofollow noopener"
                    target="_blank"
                    >https:www.kleppit.com</a
                  >
                </p>
              </li>
              <li>
            ...
            <p>
              ...
              Profile section that allows you to manage Your personal
            ...
            <p>
              ...
              contact us by email at: support@kleppit.com
            </p>
          </div>
        </div>
