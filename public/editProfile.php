            ...
            <div class="pt-2">
                <div class="container mx-auto">
                    <div class="w-full max-w-2xl p-6 mx-auto">
                        ...
                        <form action="../profile.php" method="post" class="border-t border-gray-400 mt-6 pt-4">
                        ...
                        <form action="../profile.php" method="post" class="mt-6 pt-4">
                            <div class="w-full pt-4">
                                ...
                                <div class='w-full md:w-full px-3 mb-6'>
                                    <label class="block uppercase tracking-wide text-red-500 text-xs font-bold mb-2">Profile Title</label>
