...
class IndexPostInfo extends PostInfo
{
        ...
        <div class="flex border border-[#343536] bg-[#272729] transition duration-500 ease-in-out hover:border-red-500 rounded cursor-pointer">
            ...
            <div class="w-11/12 pt-2">
                <div class="flex items-center text-xs mb-2">
                    ...
                    <a href="#" class="text-gray-500 mx-1 no-underline hover:underline">ku/' . $row[$count]["username"] . '</a>
            ...
            public function getAllPostsOrderedByKarmaAsc()
    {
        ...
        public function getAllPostsOrderedByKarmaDesc()
    {
    ...
    public function getAllPostsSortNew()
    {
    ...
    public function getAllPostsSortOldest()
    {
